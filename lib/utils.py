...
def plot_mAP(iou_aps, pose_aps, out_dir, iou_thres_list, degree_thres_list, shift_thres_list):
    ...
    plt.tight_layout()
    # plt.show()
    plt.savefig(os.path.join(out_dir, 'mAP.png'),dpi=600)
    plt.close(fig)
    return
...
def plot_mAP2(iou_aps, pose_aps, out_dir, iou_thres_list, degree_thres_list, shift_thres_list):
    """ Draw iou 3d AP vs. iou thresholds.
    """
...
def plot_mAP3(iou_aps, pose_aps, out_dir, iou_thres_list, degree_thres_list, shift_thres_list, name):
    """ Draw iou 3d AP vs. iou thresholds.
    """
...
def plot_mAP4(iou_aps, pose_aps, out_dir, iou_thres_list, degree_thres_list, shift_thres_list, name):
    ...
    colors = ['tab:pink', 'tab:blue', 'tab:gray']
    #styles = ['-', '-', '-', '-', '-', '-', '--']
    styles = ['-', '-', '-']
    fig, (ax_iou, ax_degree, ax_shift) = plt.subplots(1, 3, figsize=(8, 3.5))
    # IoU subplot
